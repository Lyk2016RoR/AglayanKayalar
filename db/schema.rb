...
ActiveRecord::Schema.define(version: 20160818135012) do
  ...
  create_table "interpreter_comments", force: :cascade do |t|
    t.text     "body"
    t.integer  "user_id"
    t.integer  "interpreter_id"
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["interpreter_id"], name: "index_interpreter_comments_on_interpreter_id", using: :btree
    t.index ["user_id"], name: "index_interpreter_comments_on_user_id", using: :btree
  end
  ...
  add_foreign_key "interpreter_comments", "interpreters"
  add_foreign_key "interpreter_comments", "users"
end
