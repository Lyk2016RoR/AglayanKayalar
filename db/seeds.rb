...
Acomment.create(body: "Süper yazar" , user_id: 1 , author_id: 1)
Acomment.create(body: "Kötü yazar" , user_id: 2 , author_id: 2)
Acomment.create(body: "İdare eder yazar" , user_id: 1 , author_id: 3)
Acomment.create(body: "Eh işte yazar" , user_id: 2 , author_id: 4)
Acomment.create(body: "Berbat yazar" , user_id: 2 , author_id: 5)
Acomment.create(body: "Omg yazar" , user_id: 1 , author_id: 6)
Acomment.create(body: "Dandik yazar" , user_id: 2 , author_id: 1)
