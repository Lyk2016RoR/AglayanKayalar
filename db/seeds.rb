...
Category.create(name:"Felsefe")
Category.create(name:"Din-Mİtoloji")
Category.create(name:"Araştırma-Tarih")
Category.create(name:"Mizah")
Category.create(name:"Çizgi Roman")
Category.create(name:"Sanat-Tasarım")
Category.create(name:"Çocuk ve Gençlik")
...
publication_year: "2016-08-12", ISBN: 123123, category_id: 1, publisher_id: 2, interpreter_id: 3)
Book.create(name: "Din Kitabı", description: "Din Özeti", page_count: 100,
publication_year: "2010-11-25", ISBN: 478975, category_id: 2, publisher_id: 3, interpreter_id: 5)
Book.create(name: "Ataştırma Kitabı", description: "Araştırma Özeti", page_count: 150,
publication_year: "1990-01-05", ISBN: 789745, category_id: 3, publisher_id: 1, interpreter_id: 2)
Book.create(name: "Mizah Kitabı", description: " Mizah Özeti", page_count: 121,
publication_year: "1900-04-04", ISBN: 97854, category_id: 4, publisher_id: 6, interpreter_id: 4)
Book.create(name: "Edebiyat Kitabı", description: "Edebiyat Özeti", page_count: 110,
publication_year: "1980-08-08", ISBN: 687997, category_id: 5, publisher_id: 5, interpreter_id: 1)
Book.create(name: "Çocuk Kitabı", description: "Çocuk Özeti", page_count: 850,
publication_year: "2000-08-11", ISBN: 456123, category_id: 6, publisher_id: 4, interpreter_id: 1)
